...
public class Sum {
    ...
    public static class SumMapper extends Mapper<LongWritable, Text, Text, DoubleWritable> {
        ...
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            String[] user_movie_subsum = value.toString().trim().split("\t");
            context.write(new Text(user_movie_subsum[0]), new DoubleWritable(Double.parseDouble(user_movie_subsum[1])));
        }
    }
